...
// jwt extractor
type jwtExtractor func(*http.Request) (string, error)

// ParseTokenFunc parse token func
type ParseTokenFunc func(auth string, req *http.Request) (*jwt.Token, error)
...
type optionSet struct {
	...
	ParseTokenFunc func(auth string, req *http.Request) (*jwt.Token, error)
}
...
func (set *optionSet) defaultParseToken(auth string, req *http.Request) (*jwt.Token, error) {
	token := new(jwt.Token)
	var err error
