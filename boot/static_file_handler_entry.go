...
const (
	...
	StaticFileHandlerEntryDescription = "Internal RK entry which implements static file handler Echo framework."
)
...
func (entry *StaticFileHandlerEntry) GetFileHandler() http.HandlerFunc {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		if file, err = entry.Fs.Open(p); err != nil {
			...
			rkmuxinter.WriteJson(w, http.StatusInternalServerError, rkerror.New(
